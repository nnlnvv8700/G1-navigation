...
def generate_launch_description():
  ...
  serialPort = LaunchConfiguration('serialPort')
  ...
  declare_serialPort = DeclareLaunchArgument('serialPort', default_value='/dev/ttyACM0', description='')
  ...
  ld.add_action(declare_serialPort)
