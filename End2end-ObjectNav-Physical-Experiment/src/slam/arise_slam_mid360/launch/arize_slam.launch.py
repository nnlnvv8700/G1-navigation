...
def generate_launch_description():
    package_share = get_share_file(
        package_name="arise_slam_mid360",
        file_name=""
    )
    workspace_root = os.path.abspath(os.path.join(package_share, "..", "..", "..", ".."))
    gtsam_lib_dir = os.path.join(workspace_root, "src", "slam", "dependency", "gtsam", "build", "gtsam")
    cephes_lib_dir = os.path.join(gtsam_lib_dir, "3rdparty", "cephes")
